...
('saikiran', 'passpass', '101', 'Sai Kiran', 'saikiran11@gmail.com');
...
CREATE TABLE `customer` (
  ...
  `name` varchar(20) DEFAULT NULL,
  `email` varchar(35) DEFAULT NULL,
  `phone_no` number(10) DEFAULT NULL,
...
('pranav', 'pranavkn', 'Pranav', 'pranav.cherry2k@gmail.com', '9535356007', 'bangalore');
